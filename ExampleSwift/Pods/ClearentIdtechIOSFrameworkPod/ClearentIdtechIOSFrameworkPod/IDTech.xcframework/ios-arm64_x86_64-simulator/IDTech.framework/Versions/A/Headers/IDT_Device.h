 ...
 * @return RETURN_CODE:  Values can be parsed with errorCode.getErrorString()
 */
-(RETURN_CODE) device_getPollMode:(NSData**)mode; //Added 8/8/2022 - MAR - Not sure if needed, universal shows only Android using this
 ...
 *
 ...
 @param merchantID Merchant unique identifier registered with Apple. Example com.idtechproducts.applePay
 @param merchantURL Merchant URL, when applicable
 
 * @return RETURN_CODE:  Return codes listed as typedef enum in IDTCommon:RETURN_CODE.  Values can be parsed with IDT_Device::device_getResponseCodeString:()
 */
-(RETURN_CODE) device_setMerchantRecord:(NSInteger*)index enabled:(BOOL)enabled merchantID:(NSString*)merchantID merchantURL:(NSString*)merchantURL; //Added 8/12/2022 - MAR
 ...
 */
-(RETURN_CODE) emv_setCAPK:(NSData*)key; //needs testing - MAR - 8/4/2022
 ...
 * @return RETURN_CODE: Values can be parsed with errorCode.getErrorString()
 */
-(RETURN_CODE) emv_generateDUKPT:(NSData*)cert signature:(NSData*)signature key:(NSData**)key; //Added 8/10/2022 - MAR
 ...
 */
-(RETURN_CODE) device_getBootloaderVersion:(NSString**)response; //Added 8/8/2022 - MAR
 ...
 */
-(RETURN_CODE) device_getTransArmorID:(NSString**)TID; //Added 8/11/2022 - MAR
